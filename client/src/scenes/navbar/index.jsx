    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3001/mergeMessages/lastMessageTimestamp/${user._id}`)
            ...
            .then((data) => {
                ...
                const lastMessageTime = new Date(data[0].lastMessageTimestamp);
                const userLeftDirectMessagesTime = new Date(userLeftDirectMessagesPage);

                // Check if the last message is more recent than userLeftDirectMessagesPage
                console.log(lastMessageTime, userLeftDirectMessagesTime, showNewMessageDot);
                if (lastMessageTime > userLeftDirectMessagesTime) {
