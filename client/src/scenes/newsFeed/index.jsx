                ...
                >
                    <Box sx={{display: 'flex', alignItems: 'center', gap: '1rem', justifyContent: 'flex-end'}}>
                        <TextField
                            ...
                            sx={{width: '150px', fontSize: '0.75rem'}} // Adjust the width and font size
                        />

                        <Button variant="contained" onClick={handleSearch} sx={{fontSize: '0.75rem'}}>
                            Search
                        </Button>
                        ...
                        {showClearButton && (
                            <Button
                                ...
                                sx={{
                                    ...
                                    height: "1px", // Adjust the height to make it smaller
                                }}
                            >
